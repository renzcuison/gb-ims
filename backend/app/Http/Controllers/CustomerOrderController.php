...
use Illuminate\Support\Facades\DB;
    ...
    class CustomerOrderController extends Controller
    {
        ...
        {
            $customerOrder = CustomerOrder::with(['orders.stock.skus'])->find($id);
        ...
        public function store(Request $request)
        {
            $baseRules = [
                ...
                'status' => 'nullable|string|in:Pending,Approved,Cancelled,Processing,Shipped,Delivered,Refunded,On Hold,Completed',
            ];
        ...
        public function update(Request $request, $id)
        {
            ...
            $validated = $request->validate([
                'status' => 'required|string|in:Pending,Approved,Cancelled,Processing,Shipped,Delivered,Refunded,On Hold,Completed',
            ]);
